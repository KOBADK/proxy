...
/**
 * Class ConfirmBookingUpdateCommand command.
 *
 * @package Koba\MainBundle\Command
 */
class ConfirmBookingUpdateCommand extends ContainerAwareCommand {
  /**
   * Configure the command
   */
  protected function configure() {
    $this->setName('koba:booking:update:confirm')
      ->addArgument(
        'id',
        InputArgument::REQUIRED,
        'Which booking entity to confirm?'
      )
      ->setDescription('Confirm booking update in Exchange');
  }
